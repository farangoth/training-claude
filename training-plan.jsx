...
const WEEKS = [
  {
    ...
    days: [
      ...
      {
        day: "Tue", date: "30 Jun", label: "Strength + Run", type: "strength", emoji: "🏋",
        ...
        preDetail: {
          ...
          strengthFocus: ["Single-leg glute bridges 3x12 each side (ITB/hip primary)", "Copenhagen adductor holds 3x20 sec (ITB support)", "Step-ups with knee drive 3x10 each leg (trail specificity)", "Calf raises eccentric slow 3x15 (Achilles resilience)", "Dead bugs 3x10 (core stability for downhill control)"],
      ...
      {
        day: "Thu", date: "2 Jul", label: "Strength + Run", type: "strength", emoji: "🏋",
        ...
        preDetail: {
          ...
          hrTarget: "<152 bpm",
          shoes: "Kiprun KS900 or KD900 Light",
          terrain: "Indoor treadmill. Optionally 2x5 min at 5-8% incline  --  but HR must stay <152 bpm.",
          strengthFocus: ["Romanian deadlift 3x10 (posterior chain, glute load)", "Lateral band walks 3x15 each direction (ITB/hip abductor)", "Bulgarian split squat 3x8 each leg (quad + glute trail power)", "Plank variations 3x45 sec", "Reverse lunge with reach 3x10 each side"],
      ...
      {
        day: "Sat", date: "4 Jul", label: "Long Mountain Day", type: "long", emoji: "mountain",
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Tue", date: "7 Jul", label: "Strength + Run", type: "strength", emoji: "🏋", summary: "Treadmill 4 km + 45 min S&C", tag: "STRENGTH", tagColor: "#f59e0b",
        preDetail: { title: "Treadmill + Strength", duration: "Treadmill 25 min + S&C 45 min", distance: "4 km", elevation: "0 m", hrTarget: "<150 bpm", shoes: "Kiprun KS900", terrain: "Indoor treadmill 0% incline.", strengthFocus: ["Single-leg glute bridges 4x12 each side", "Copenhagen adductor holds 4x20 sec", "Step-ups with knee drive 3x12 each leg", "Calf raises eccentric 3x15", "Dead bugs 3x12", "Pallof press 3x10 each side (add from W2)"], keyFocus: "Add Pallof press this week to begin rotational core stability for technical terrain." } },
      ...
      { day: "Thu", date: "9 Jul", label: "Strength + Run", type: "strength", emoji: "🏋", summary: "Treadmill 5 km + 35 min S&C", tag: "STRENGTH", tagColor: "#f59e0b",
        preDetail: { title: "Treadmill + Strength", duration: "Treadmill 35 min + S&C 35 min", distance: "5 km", elevation: "0 m", hrTarget: "<152 bpm", shoes: "Kiprun KS900", terrain: "Indoor treadmill. Try 3x5 min at 6% incline if HR stays <152 bpm.", strengthFocus: ["Romanian deadlift 3x12 (increase weight vs W1)", "Lateral band walks 3x15", "Bulgarian split squat 3x10 each leg", "Plank 3x50 sec", "Reverse lunge with reach 3x12 each side"], keyFocus: "Incline on treadmill is your first vertical-specific prep without the ITB risk of real descent." } },
      { day: "Fri", date: "10 Jul", label: "Rest / Mobility", type: "rest", emoji: "🧘", summary: "Rest before long day", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest Day  --  Pre-Long", duration: "15 min mobility only", distance: " -- ", elevation: " -- ", mobilityWork: ["Hip flexor + quad stretch 3x60 sec", "Foam roll calves + ITB"], keyFocus: "Protect Saturday. No bonus runs." } },
      { day: "Sat", date: "11 Jul", label: "Long Mountain Day", type: "long", emoji: "mountain", summary: "13-15 km * 450-550 m+ * 2h45-3h15", tag: "LONG", tagColor: "#f97316",
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Tue", date: "14 Jul", label: "Strength + Run", type: "strength", emoji: "🏋", summary: "Treadmill 5 km + 40 min S&C", tag: "STRENGTH", tagColor: "#f59e0b", preDetail: { title: "Treadmill + Strength", duration: "Treadmill 35 min + S&C 40 min", distance: "5 km", elevation: "0 m", hrTarget: "<155 bpm. Try 8% incline for 2x8 min.", shoes: "Kiprun KS900 or KD900 Light", terrain: "Indoor treadmill. Progressive incline block.", strengthFocus: ["Single-leg glute bridges 4x15 each side", "Copenhagen holds 4x25 sec", "Step-ups with weight 3x12 each leg", "Eccentric calf raises 4x15", "Dead bugs 3x12", "Pallof press 3x12 each side"], keyFocus: "Incline on treadmill is preparing your hip flexors for Jacob's Ladder." } },
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Thu", date: "30 Jul", label: "Strength (Maintenance)", type: "strength", emoji: "🏋", summary: "35 min S&C", tag: "STRENGTH", tagColor: "#f59e0b", preDetail: { title: "Maintenance Strength", duration: "35 min", distance: " -- ", elevation: " -- ", strengthFocus: ["Single-leg glute bridges 3x12", "Copenhagen holds 3x20 sec", "Eccentric calf raises 3x12", "Dead bugs 3x10"], keyFocus: "Last strength session of the block. Keep it light and quality-focused." } },
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Tue", date: "4 Aug", label: "Aerobic + Strides", type: "easy", emoji: "🫁", summary: "6 km + 6x strides", tag: "AEROBIC", tagColor: "#60a5fa", preDetail: { title: "Easy Run + Strides", duration: "40 min", distance: "6 km", elevation: "<60 m+", hrTarget: "<150 bpm easy. Strides: 20-30 sec at 5km pace, full recovery between.", shoes: "Kiprun KD900 Light or KS900", terrain: "Flat road or towpath.", keyFocus: "Strides remind your neuromuscular system that speed exists. 6x at the end of the run." } },
...
async function fetchCoachComment(day, result) {
  const prompt = `You are an elite running coach. Analyse this completed training session for Clement Savalle-Anthonioz, an experienced trail runner (9yr history, HM PR 1h35, FTP 200W, 70kg) targeting the Snowdon SkyRace (38km/3150m+) on 15 Aug 2026.
...
function SyncBadge({ status }) {
  const cfg = {
    syncing: { color:"#f59e0b", label:"syncing syncing" },
    synced:  { color:"#4ade80", label:"v GitHub" },
    offline: { color:"#64748b", label:"o local"  },
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column", gap:"0.75rem" }}>
      ...
      <div style={{ display:"flex", gap:"0.5rem" }}>
        <button onClick={()=>onSubmit(form)} style={{ flex:1, background:s.accent, border:"none", borderRadius:6, padding:"0.6rem", fontWeight:700, fontSize:"0.8rem", color:"#080b12", cursor:"pointer" }}>Mark Complete v</button>
      ...
      <div onClick={e=>e.stopPropagation()} style={{ background:"#0d1018", border:`1px solid ${s.border}`, borderRadius:14, padding:"2rem", maxWidth:580, width:"100%", maxHeight:"88vh", overflowY:"auto", boxShadow:`0 0 60px ${s.border}25` }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"1.5rem" }}>
          <div>
            ...
            {isCompleted && <div style={{ marginTop:4 }}><Tag label="v COMPLETED" color="#4ade80" /></div>}
          </div>
        ...
        {isCompleted && result ? (
          ...
          <>
            ...
            {showLog
              ...
              : <button onClick={()=>setShowLog(true)} style={{ width:"100%", background:s.accent, border:"none", borderRadius:8, padding:"0.75rem", fontWeight:700, fontSize:"0.85rem", color:"#080b12", cursor:"pointer", marginTop:4 }}>v Mark as Complete</button>}
  ...
  return (
    <button onClick={onClick} style={{ all:"unset", cursor:"pointer", display:"flex", flexDirection:"column", background:s.bg, border:`1px solid ${isCompleted?s.border:"#1a2030"}`, borderRadius:10, padding:"1rem", gap:"0.45rem", transition:"all 0.18s ease", textAlign:"left", position:"relative", overflow:"hidden", minHeight:130 }}
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center" }}>
        ...
        <span style={{ fontSize:"1rem" }}>{isCompleted?"[done]":day.emoji}</span>
      </div>
