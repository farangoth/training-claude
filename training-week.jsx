...
function buildInitialState() {
  ...
  // Seed pre-completed days (type:"done" with a result object) from WEEKS data
  const seeded = {};
  WEEKS.forEach(w => {
    w.days.forEach(d => {
      if (d.type === "done" && d.result) {
        const key = `w${w.number}_${d.day}${d.date}`;
        seeded[key] = { completed: true, result: d.result, aiComment: d.result.comment };
      }
    });
  });
  saveState(seeded);
...
const WEEKS = [
    ...
    days: [
      {
        ...
        result: {
          distance: "9.55 km",
          duration: "1h02 moving / 1h08 elapsed",
          elevation: "252 m+",
          avgHR: "144 bpm avg",
          peakHR: "174 bpm (final ascent km 9–9.5)",
          avgWatts: "193 W avg power",
          cadence: "79 spm avg · RPE 4/10",
  ...
  },
  {
    ...
    days: [
      { day: "Sun", date: "12 Jul", label: "Trail Run", type: "easy", emoji: "🏃", summary: "10 km · 250 m+ · HR <158", tag: "TRAIL", tagColor: "#4ade80",
        preDetail: { title: "Sunday Trail Run", duration: "65–75 min", distance: "10 km", elevation: "250 m+", hrTarget: "140–158 bpm (new ceiling)", shoes: "The North Face Vectiv Sky — test run on this route", terrain: "Rolling moorland trail. Try the Vectiv Sky on this run to begin breaking it in for Snowdon.", routes: ["Lantern Pike + Cown Edge — 10 km, 260 m+"], keyFocus: "First run in the Vectiv Sky? Note feel, hotspots, toe box. This shoe will carry you on race day." } },
      { day: "Mon", date: "13 Jul", label: "Easy Run", type: "easy", emoji: "🫁", summary: "5 km · flat · HR <148", tag: "RECOVERY", tagColor: "#60a5fa",
        preDetail: { title: "Recovery Run", duration: "30–35 min", distance: "5 km", elevation: "<40 m+", hrTarget: "<148 bpm", shoes: "Kiprun KS900", terrain: "Sett Valley Trail — flat, zero technical.", keyFocus: "Flush the legs from Sunday. Keep it genuinely easy." } },
      ...
      { day: "Wed", date: "15 Jul", label: "Rest / Mobility", type: "rest", emoji: "🧘", summary: "Rest day", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest Day", duration: "20 min mobility", distance: "—", elevation: "—", mobilityWork: ["Full hip circuit — flexor, glute, pigeon", "Foam roll ITB + calves", "Foot rolling (plantar fascia prep for race)"], keyFocus: "3 weeks to race. Rest is earning fitness now." } },
  ...
  },
  {
    ...
    days: [
      { day: "Sun", date: "19 Jul", label: "Trail Run", type: "easy", emoji: "🏃", summary: "10 km · 300 m+ · HR <160", tag: "TRAIL", tagColor: "#4ade80",
      ...
      { day: "Mon", date: "20 Jul", label: "Recovery Run", type: "easy", emoji: "🫁", summary: "5 km flat · HR <145", tag: "RECOVERY", tagColor: "#60a5fa",
        preDetail: { title: "Recovery", duration: "30 min", distance: "5 km", elevation: "<40 m+", hrTarget: "<145 bpm", shoes: "Kiprun KS900", terrain: "Sett Valley flat.", keyFocus: "True recovery. No heroics." } },
      { day: "Tue", date: "21 Jul", label: "Strength (Maintenance)", type: "strength", emoji: "🏋️", summary: "40 min S&C · No treadmill", tag: "STRENGTH", tagColor: "#f59e0b",
  ...
  },
  {
    ...
    days: [
      { day: "Sun", date: "26 Jul", label: "Trail Run", type: "easy", emoji: "🏃", summary: "10 km · 300 m+ · HR <160", tag: "TRAIL", tagColor: "#4ade80",
        preDetail: { title: "Sunday Trail Run", duration: "65–70 min", distance: "10 km", elevation: "300 m+", hrTarget: "140–160 bpm on climbs", shoes: "The North Face Vectiv Sky", terrain: "Technical moorland — use the race shoe.", routes: ["Kinder plateau rim — 10 km, 300 m+"], keyFocus: "Note how your legs feel after last week's big day. That fatigue is fitness being built." } },
      { day: "Mon", date: "27 Jul", label: "Rest", type: "rest", emoji: "🧘", summary: "Full rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Full Rest", duration: "—", distance: "—", elevation: "—", mobilityWork: ["Light hip stretching", "Sleep priority"], keyFocus: "The taper starts next week. Absorb this week's load first." } },
      { day: "Tue", date: "28 Jul", label: "Uphill Quality", type: "long", emoji: "📈", summary: "7 km · 320 m+ · quality session", tag: "QUALITY", tagColor: "#f97316",
        preDetail: { title: "Uphill Quality — Peak Intensity Week", duration: "55–65 min", distance: "7 km", elevation: "320 m+", hrTarget: "Efforts: 160–163 bpm. Recovery: <145 bpm.", shoes: "New Balance Summit SG", terrain: "Steep consistent gradient. Kinder or Lantern Pike.", routes: ["5×8 min uphill efforts — Lantern Pike or Kinder Low approach", "3×14 min Jacob's Ladder sustained"], keyFocus: "Push harder than Week 4 Wednesday. This is the final quality stimulus before taper." } },
      { day: "Wed", date: "29 Jul", label: "Easy Recovery", type: "easy", emoji: "🫁", summary: "5 km · flat · HR <145", tag: "RECOVERY", tagColor: "#60a5fa",
        preDetail: { title: "Recovery Run", duration: "30 min", distance: "5 km", elevation: "<40 m+", hrTarget: "<145 bpm", shoes: "Kiprun KS900", terrain: "Sett Valley flat.", keyFocus: "Legs will be heavy. Walk if needed." } },
      { day: "Thu", date: "30 Jul", label: "Strength (Maintenance)", type: "strength", emoji: "🏋️", summary: "35 min S&C", tag: "STRENGTH", tagColor: "#f59e0b",
        preDetail: { title: "Maintenance Strength", duration: "35 min", distance: "—", elevation: "—", strengthFocus: ["Single-leg glute bridges 3×12", "Copenhagen holds 3×20 sec", "Eccentric calf raises 3×12", "Dead bugs 3×10"], keyFocus: "Last strength session of the block. Keep it light and quality-focused." } },
      { day: "Fri", date: "31 Jul", label: "Rest", type: "rest", emoji: "🧘", summary: "Rest before final long run", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest Day", duration: "—", distance: "—", elevation: "—", mobilityWork: ["Full hip and calf circuit", "Foot care check"], keyFocus: "Final big day tomorrow. Eat well and sleep well tonight." } },
      { day: "Sat", date: "1 Aug", label: "Final Long Day", type: "long", emoji: "⛰️", summary: "15–17 km · 700–800 m+ · 3h15", tag: "LONG", tagColor: "#f97316",
        preDetail: { title: "Final Long Mountain Day — Last Hard Effort", duration: "3h–3h30", distance: "15–17 km", elevation: "700–800 m+", hrTarget: "Race-like effort: climbs to 163 bpm, flats 145–155, descents controlled.", shoes: "The North Face Vectiv Sky", pack: "Full race simulation kit", terrain: "North Wales or Peak District — technical mountain trail. Snowdon Pyg Track again strongly recommended as final recon.", routes: ["Snowdon Pyg Track recon — cement race-day strategy", "Tryfan approach — 14 km, ~850 m+"], nutrition: "Full race nutrition. Practice your gel timing to the second.", keyFocus: "End this run feeling you could do another 2 hours slowly. If you finish depleted, you went too hard — adjust race pacing plan accordingly." } },
    ],
  },
  {
    ...
    days: [
      { day: "Sun", date: "2 Aug", label: "Easy Trail Run", type: "easy", emoji: "🏃", summary: "8 km · 200 m+ · HR <155", tag: "TRAIL", tagColor: "#4ade80",
        preDetail: { title: "Taper Opener", duration: "50–55 min", distance: "8 km", elevation: "200 m+", hrTarget: "<155 bpm", shoes: "The North Face Vectiv Sky", terrain: "Familiar local trail. Nothing new.", keyFocus: "Last week's hard work is done. Begin letting go of the load." } },
      { day: "Mon", date: "3 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Full rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest", duration: "—", distance: "—", elevation: "—", mobilityWork: ["Light stretching only"], keyFocus: "Sleep. Eat. Hydrate." } },
      { day: "Tue", date: "4 Aug", label: "Aerobic + Strides", type: "easy", emoji: "🫁", summary: "6 km + 6× strides", tag: "AEROBIC", tagColor: "#60a5fa",
      ...
      { day: "Wed", date: "5 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest Day", duration: "—", distance: "—", elevation: "—", mobilityWork: ["Hip + calf light circuit"], keyFocus: "Mentally rehearse the race start. Walk the first km in your mind." } },
      { day: "Thu", date: "6 Aug", label: "Short Trail Run", type: "easy", emoji: "🏃", summary: "5 km · 150 m+ · HR <155", tag: "TRAIL", tagColor: "#4ade80",
        preDetail: { title: "Short Sharp Trail", duration: "35 min", distance: "5 km", elevation: "150 m+", hrTarget: "<155 bpm", shoes: "The North Face Vectiv Sky", terrain: "Brief hill trail — include one short steep climb at race effort.", keyFocus: "Wake the legs up. Include 2 min at race effort on the climb." } },
      { day: "Fri", date: "7 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Travel day / Full rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Travel Day", duration: "—", distance: "—", elevation: "—", mobilityWork: ["Walk 20 min easy", "Hydrate aggressively all day"], keyFocus: "Travel to Snowdonia. Kit check. Early dinner and bed by 9pm." } },
      { day: "Sat", date: "8 Aug", label: "Race Prep Walk", type: "rest", emoji: "🎯", summary: "10 min shakeout + kit check", tag: "PRE-RACE", tagColor: "#f97316",
        preDetail: { title: "Pre-Race Shakeout", duration: "10–15 min walk/jog", distance: "<2 km", elevation: "minimal", hrTarget: "No HR target. Very easy.", shoes: "The North Face Vectiv Sky", keyFocus: "10 min easy jog or brisk walk. Just to move the legs. Check kit one final time. Sleep by 9pm." } },
    ],
  },
  {
    ...
    days: [
      { day: "Sun", date: "9 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Full rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Full Rest", duration: "—", distance: "—", elevation: "—", keyFocus: "Legs up. Eat well. Hydrate." } },
      { day: "Mon", date: "10 Aug", label: "Very Easy Jog", type: "easy", emoji: "🫁", summary: "3–4 km · flat · HR <140", tag: "EASY", tagColor: "#60a5fa",
        preDetail: { title: "Light Leg Flush", duration: "20 min", distance: "3–4 km", elevation: "<20 m+", hrTarget: "<140 bpm", shoes: "Any comfortable shoe", terrain: "Flat road only.", keyFocus: "Keep the legs ticking. Nothing more." } },
      { day: "Tue", date: "11 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Rest", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest", duration: "—", distance: "—", elevation: "—", keyFocus: "Walk 20 min. Hydrate. Sleep." } },
      { day: "Wed", date: "12 Aug", label: "Very Easy Jog", type: "easy", emoji: "🫁", summary: "3 km · flat · + 4 strides", tag: "EASY", tagColor: "#60a5fa",
        preDetail: { title: "Final Leg Activation", duration: "20 min", distance: "3 km", elevation: "<10 m+", hrTarget: "<140 bpm + 4 strides at race pace", shoes: "The North Face Vectiv Sky", terrain: "Flat only.", keyFocus: "4 strides at race pace. This reminds the legs what the job is." } },
      { day: "Thu", date: "13 Aug", label: "Rest", type: "rest", emoji: "🧘", summary: "Rest / travel", tag: "REST", tagColor: "#a78bfa",
        preDetail: { title: "Rest Day", duration: "—", distance: "—", elevation: "—", keyFocus: "If not already in Snowdonia: travel today. Walk registration area. Eat carbs all day." } },
      { day: "Fri", date: "14 Aug", label: "Race Eve", type: "rest", emoji: "🎯", summary: "Kit check · Early bed", tag: "PRE-RACE", tagColor: "#f97316",
        preDetail: { title: "Race Eve Protocol", duration: "10 min shakeout walk only", distance: "<1 km", elevation: "—", keyFocus: "Lay out every piece of kit the night before. Confirm mandatory gear. Dinner at 6pm. In bed by 9pm. Trust the training." } },
      { day: "Sat", date: "15 Aug", label: "🏁 RACE DAY", type: "long", emoji: "🏔️", summary: "38 km · 3,150 m+ · Snowdon SkyRace", tag: "RACE", tagColor: "#f97316",
        preDetail: { title: "Snowdon SkyRace — Race Day", duration: "Target: finish strong", distance: "38 km", elevation: "3,150 m+", hrTarget: "Climbs: up to 163 bpm. Flats: 145–155. Descents: controlled, protect ITB.", shoes: "The North Face Vectiv Sky", pack: "Mandatory kit + race vest", terrain: "Technical mountain trail — Snowdonia. Rocky ridgelines, sustained ascents, technical descents. This is what every session in this block was preparing for.", keyFocus: "You have done the work. Run your plan. Hike the steep stuff. Eat every 40 min. Enjoy the mountains. This is a long day in the mountains — and you are ready for it." } },
    ],
  },
];
...
Write a 2-3 sentence coaching debrief. Be direct, analytical, and specific to the data. Reference the HR cap (${day.preDetail.hrTarget || "155 bpm"}) and what it means for adaptation. End with one precise tactical instruction for the next session. No generic praise. No emojis.`;
...
function Tag({ label, color }) {
  return (
    <span style={{ fontSize: "0.58rem", fontWeight: 700, letterSpacing: "0.1em", color, border: `1px solid ${color}`, borderRadius: 3, padding: "1px 6px", fontFamily: "monospace" }}>
      {label}
    </span>
  );
}
...
function LogForm({ day, onSubmit, onCancel }) {
  ...
  const inputStyle = { background: "#12151f", border: "1px solid #1e2535", borderRadius: 6, padding: "0.5rem 0.75rem", color: "#f1f5f9", fontSize: "0.83rem", width: "100%", boxSizing: "border-box", fontFamily: "inherit" };
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "0.5rem" }}>
        {[["Distance (km)", "distance"], ["Duration", "duration"], ["Elevation (m+)", "elevation"]].map(([lbl, key]) => (
          <div key={key}>
            <div style={{ fontSize: "0.55rem", color: "#64748b", fontFamily: "monospace", marginBottom: 3 }}>{lbl}</div>
            <input style={inputStyle} value={form[key]} onChange={e => set(key, e.target.value)} placeholder="—" />
          </div>
        ))}
      </div>
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" }}>
        {[["Avg HR (bpm)", "avgHR"], ["Peak HR (bpm)", "peakHR"]].map(([lbl, key]) => (
          <div key={key}>
            <div style={{ fontSize: "0.55rem", color: "#64748b", fontFamily: "monospace", marginBottom: 3 }}>{lbl}</div>
            <input style={inputStyle} value={form[key]} onChange={e => set(key, e.target.value)} placeholder="—" />
          </div>
      ...
      <div>
        ...
        <textarea style={{ ...inputStyle, resize: "vertical", minHeight: 60 }} value={form.notes} onChange={e => set("notes", e.target.value)} placeholder="How did it feel? Any issues?" />
      </div>
      <div style={{ display: "flex", gap: "0.5rem" }}>
        <button onClick={() => onSubmit(form)} style={{ flex: 1, background: s.accent, border: "none", borderRadius: 6, padding: "0.6rem", fontWeight: 700, fontSize: "0.8rem", color: "#080b12", cursor: "pointer" }}>
          Mark Complete ✓
        </button>
        <button onClick={onCancel} style={{ background: "transparent", border: "1px solid #334155", borderRadius: 6, padding: "0.6rem 1rem", color: "#64748b", fontSize: "0.8rem", cursor: "pointer" }}>
          Cancel
        </button>
      </div>
    </div>
...
function DayModal({ day, sessionKey, sessionData, onClose, onLog, onUnlog }) {
  const s = TYPE_STYLES[day.type] || TYPE_STYLES.easy;
        ...
        {isCompleted && result ? (
          <>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "0.6rem" }}>
                {[["Distance", result.distance], ["Duration", result.duration], ["Elevation", result.elevation], ["Avg HR", result.avgHR], ["Peak HR", result.peakHR], ["Avg Power", result.avgWatts], ["Cadence / RPE", result.cadence]].filter(([,v])=>v).map(([k,v])=>(
            ...
            <button onClick={onUnlog} style={{ background: "transparent", border: "1px solid #334155", borderRadius: 6, padding: "0.5rem 1rem", color: "#64748b", fontSize: "0.75rem", cursor: "pointer" }}>
          ...
          <>
            ...
            {showLog ? (
              ...
              <button onClick={() => setShowLog(true)} style={{ width:"100%", background: s.accent, border:"none", borderRadius:8, padding:"0.75rem", fontWeight:700, fontSize:"0.85rem", color:"#080b12", cursor:"pointer", marginTop:4 }}>
                ✓ Mark as Complete
              </button>
            )}
            {loadingAI && (
              <div style={{ textAlign:"center", marginTop:"1rem", fontSize:"0.8rem", color:"#64748b", fontStyle:"italic" }}>
                Getting coach analysis...
              </div>
            )}
          </>
        )}
...
function DayTile({ day, sessionData, onClick }) {
  ...
  return (
    <button onClick={onClick} style={{ all:"unset", cursor:"pointer", display:"flex", flexDirection:"column", background: s.bg, border:`1px solid ${isCompleted ? s.border : "#1a2030"}`, borderRadius:10, padding:"1rem", gap:"0.45rem", transition:"all 0.18s ease", textAlign:"left", position:"relative", overflow:"hidden", minHeight: 130 }}
      ...
      {isCompleted && result ? (
        <div style={{ fontSize:"0.68rem", color:"#4ade80", fontFamily:"monospace", lineHeight:1.4 }}>
...
function WeekSelector({ weeks, currentIdx, onSelect }) {
  return (
    <div style={{ display:"flex", gap:"0.35rem", flexWrap:"wrap", marginBottom:"1.5rem" }}>
      {weeks.map((w, i) => {
        const phaseColor = PHASE_COLORS[w.phase - 1];
        const isActive = i === currentIdx;
        return (
          <button key={i} onClick={() => onSelect(i)} style={{ all:"unset", cursor:"pointer", display:"flex", flexDirection:"column", alignItems:"center", padding:"0.45rem 0.65rem", borderRadius:7, border:`1px solid ${isActive ? phaseColor : "#1e2535"}`, background: isActive ? `${phaseColor}18` : "transparent", transition:"all 0.15s ease", minWidth:44 }}
            onMouseEnter={e=>{ if(!isActive){ e.currentTarget.style.border=`1px solid ${phaseColor}80`; e.currentTarget.style.background=`${phaseColor}08`; }}}
            onMouseLeave={e=>{ if(!isActive){ e.currentTarget.style.border="1px solid #1e2535"; e.currentTarget.style.background="transparent"; }}}>
            <span style={{ fontSize:"0.6rem", fontWeight:700, color: isActive ? phaseColor : "#475569", fontFamily:"monospace" }}>W{w.number}</span>
            <span style={{ fontSize:"0.5rem", color: isActive ? phaseColor : "#334155", fontFamily:"monospace", textAlign:"center", lineHeight:1.2, marginTop:2, maxWidth:50 }}>{w.block.split(" ")[0]}</span>
          </button>
        );
      })}
    </div>
...
export default function App() {
  ...
  const [sessions, setSessions] = useState(() => buildInitialState());
  ...
  const completedDays = week.days.filter(d => sessions[sessionKey(d)]?.completed).length;
  const totalSessions = week.days.filter(d => d.type !== "rest").length;
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080b12", color:"#f1f5f9", fontFamily:"'Inter', system-ui, sans-serif", padding:"1.75rem 1.5rem", maxWidth:940, margin:"0 auto" }}>
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:"1.5rem", flexWrap:"wrap", gap:"0.75rem" }}>
        <div>
          <div style={{ fontSize:"0.58rem", letterSpacing:"0.15em", color:"#f97316", fontFamily:"monospace", fontWeight:700, marginBottom:6 }}>SNOWDON SKYRACE · 15 AUG 2026</div>
      ...
      <div style={{ display:"flex", gap:"0.4rem", marginBottom:"1.25rem" }}>
        {PHASE_LABELS.map((l, i) => (
          <div key={i} style={{ flex:1, height:3, borderRadius:99, background: week.phase - 1 === i ? PHASE_COLORS[i] : week.phase - 1 > i ? `${PHASE_COLORS[i]}60` : "#1e2535", transition:"background 0.3s" }} />
        ))}
      </div>
      <div style={{ display:"flex", gap:"1rem", marginBottom:"1.5rem" }}>
        {PHASE_LABELS.map((l, i) => (
          <span key={i} style={{ fontSize:"0.55rem", color: week.phase - 1 === i ? PHASE_COLORS[i] : "#334155", fontFamily:"monospace", letterSpacing:"0.06em", fontWeight: week.phase - 1 === i ? 700 : 400 }}>{l}</span>
        ))}
      </div>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(185px, 1fr))", gap:"0.8rem", marginBottom:"1.75rem" }}>
        {week.days.map((day, i) => (
          <DayTile key={i} day={day} sessionData={sessions[sessionKey(day)]} onClick={() => setSelected(day)} />
        ))}
      </div>
      ...
      {selected && (
        <DayModal
          ...
          onLog={(data) => { handleLog(selected, data); setSelected(null); }}
          onUnlog={() => { handleUnlog(selected); setSelected(null); }}
        />
      )}
    </div>
  );
